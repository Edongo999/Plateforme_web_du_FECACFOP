...
<head>
  ...
  <style>
    ...
    .form-group.with-icon input { padding-right: 32px; position: relative; z-index: 2; }
    ...
    .separator { text-align: center; margin: 15px 0; }
    .social-login {
      display: flex;
      justify-content: center;
      gap: 15px;
    ...
    .reset-form.active, .login-form.active { display: block; }
    .login-form:not(.active), .reset-form:not(.active) { display: none; }
