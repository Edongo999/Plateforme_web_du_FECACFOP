...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <link rel="stylesheet" href="/Plateforme_web_du_FECACFOP/public/assets/css_actualites/lightbox/css/lightbox.min.css">  
      <link rel="stylesheet" href="/Plateforme_web_du_FECACFOP/public/assets/css_actualites/style.css">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-5 col-12">
                    <ul class="top-link">
                       <li><i class="fa fa-map-marker"></i>Douala, Bonapriso rue Koloko</li>
                ...
                <div class="col-lg-6 col-md-7 col-12">
                    <ul class="top-contact">
                        ...
                        <li><i class="fa fa-envelope"></i><a href="https://mail.google.com/mail/?view=cm&fs=1&to=support@yourmail.com" target="_blank">
                        ...
                        <div class="main-menu">
                            <nav class="navigation">
                                ...
                                <ul class="nav menu">
                                   ...
                                   <ul class="dropdown">
                                    <li>
                                        <a href="/Plateforme_web_du_FECACFOP/view/formulaire/index1.php">
                                        Vous êtes un apprenant ?
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#modalSelection">
                                        Vous êtes un centre ou autres ?
                                        </a>
                                    </li>
                                    </ul>
                                    ...
                                    <li class="<?= ($current_page == 'afficher_emplois_test.php') ? 'active' : '' ?>"><a href="/Plateforme_web_du_FECACFOP/view/Actualites/afficher_emplois_test.php">Emplois Et Stage</a></li>
